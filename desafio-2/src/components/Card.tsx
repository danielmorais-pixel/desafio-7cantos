...
interface CardProps {
  imovel: Imovel; // Objeto com dados do imóvel
  estaFavoritado: boolean; // Indica se o imóvel está favoritado
  toggleFavorito: (id: number) => void; // Função para adicionar/remover dos favoritos
}
